...
export const getAllDomain = async ({
  ...
  try {
    const response = await axiosClient.get(
      `${ENDPOINT.GETALLDOMAIN}?${params.toString()}`,
    );
...
export const getChildrenDomain = async ({
  ...
  const response = await axiosClient.get(
    `${ENDPOINT.GET_CHILDREN_DOMAIN}?${params.toString()}`,
    {
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
export const getParentDomains = async ({
  ...
  if (sortDir) params.append("sortDir", sortDir);
  const response = await axiosClient.get(
    `${ENDPOINT.GET_PARENT_DOMAIN}?${params.toString()}`,
    {
      headers: {
        Authorization: `Bearer ${token}`,
      },
...
export const getChildrenDomainsByParentId = async ({
  ...
  if (sortDir) params.append("sortDir", sortDir);
  const response = await axiosClient.get(
    `${ENDPOINT.GETDOMAIN}/${parentId}/getChildrenTag`,
    {
      headers: {
        Authorization: `Bearer ${token}`,
      },
