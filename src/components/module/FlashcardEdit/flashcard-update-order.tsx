...
interface FlashcardUpdateOrderProps {
...
const FlashcardUpdateOrder = ({
  fields,
  handleDragEnd,
}: FlashcardUpdateOrderProps) => {
  return (
                ...
                {(provided) => (
                  ...
                  >
                    ...
                    <div className="flex flex-row text-2xl font-bold">
                      <div className="flex-1">{field.japaneseDefinition}</div>
...
export default FlashcardUpdateOrder;
